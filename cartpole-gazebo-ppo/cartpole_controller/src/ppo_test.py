...
def argparser():
    ...
    parser.add_argument('--modeldir', help='directory of model', default='model')
    parser.add_argument('--alg', help='chose algorithm ppo', default='ppo')
    ...
    parser.add_argument('--iteration', default=int(2e3))
